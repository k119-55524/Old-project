Проект TestDI создан для демонстрации принципа dependency injection при создании игр на движке Unity и не преследует коммерческих целей. Все использованные в проекте арт ресурсы найденны на просторах интернета, все права на них принадлежат их владельцам.
