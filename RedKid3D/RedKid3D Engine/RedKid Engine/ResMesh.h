...
protected:
	...
	virtual HRESULT LoadSceletBlock( std::ifstream &file, TCHAR* FileName );
	virtual HRESULT InitResIndividualData( VERTEX_TBN_UV_BONE* Vertex, UINT VertexCount, DWORD* Index, UINT IndexCount ) { return S_OK; };
	CResMat* cMaterial;
