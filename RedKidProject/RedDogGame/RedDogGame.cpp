...
HRESULT CALLBACK OnInicialise( void )
{
	...
	V_RETURN( RedKid.CreateMatTexture( _T("Terrain_000"), IndexMat, _T( "GameResource\\Textures\\Generator_000.jpg" ) ) );
	//V_RETURN( RedKid.AddPhysXTriangleStaticMeshObject( Obj, NULL, _T( "GameResource\\Mesh\\delmy.RM3DT" ), IndexMat, NULL, true ) );
	V_RETURN( RedKid.AddPhysXTriangleStaticMeshObject( Obj, NULL, _T( "GameResource\\Mesh\\Terrain_000.RM3DT" ), IndexMat, NULL, true ) );
	((CObjectPhysX*)Obj)->SetPhysXPosition( 20.0f, -200.0f, 0.0f );

	V_RETURN( RedKid.CreateMatTexture( _T("Dinamic_000"), IndexMat, _T( "GameResource\\Textures\\001.jpg" ) ) );
