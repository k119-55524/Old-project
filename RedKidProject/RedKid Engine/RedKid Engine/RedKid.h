...
public:
	...
	inline HRESULT AddMeshSceletAnimation( UINT IndexMesh, TCHAR* FileName, UINT &IndexAddAnim, bool fSetAnim = false )
	{
		return cResManager.AddMeshSceletAnimation( IndexMesh, FileName, IndexAddAnim, fSetAnim );
	};
